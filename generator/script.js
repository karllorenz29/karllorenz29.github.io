function clearAll() {
    ...
    document.querySelector('.wisdom').innerHTML = "";
...
function showMeme() {
  ...
  e.src = randomMemeUrl;
  clearAll();
  document.querySelector('.meme').appendChild(e);
}
...
function showJoke() {
  ...
  e.textContent = randomJokeText;
  clearAll();
  document.querySelector('.joke').appendChild(e);
}
...
function showQuote() {
  ...
  const c = document.querySelector('.wisdom');
  const e = document.createElement('p');
...
function showRiddle() {
  ...
  const c = document.querySelector('.riddle');
  const e = document.createElement('p');
  const e2 = document.createElement('p');
  e.textContent = question;
  e2.textContent = "- " + answer;
  e2.id = "answer"
  e2.hidden = true;
  clearAll();
  c.appendChild(e);
...
function revealAnswers() {
    const c = document.querySelector('.riddle');
    const r = c.querySelector('p');
    const a = document.querySelector('#answer');
    if (r && a.hidden) {
        a.hidden = false;
    }else if (!r) {
        alert("No riddle to be answered!");
    }else {
        alert("The answer of the riddle is already revealed!");
    }
}
